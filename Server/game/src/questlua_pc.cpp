...
teleport_area:
	...
	{
		LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
		const char* character_list[8] = { "Savaþçý", "Ninja", "Sura", "?man", "Savaþçý", "Ninja", "Sura", "?man" };
	...
	{
		LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
		const char* character_list[8] = { "Erkek Savaþçý", "K? Ninja", "Erkek Sura", "K? ?man", "K? Savaþçý", "Erkek Ninja", "K? Sura", "?man Erkek" };
