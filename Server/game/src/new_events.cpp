...
#include "new_events.h"
		...
		{
			char const * MSG[] = {
									"Arena savasi yeni basladi,",
									"Savasa katilmak isterseniz, Savas Sorumlusu ile konusun.",
									"Arena savasi bitti,",
									"Tum katilimcilar kralliga isinlanacak veya.",
									"Bu makale burada kullanılamaz.",
									"%s savasi kazanir,",
									"Tum katilimcilar kralliga isinlanacak veya.",
									"Oyuncular %s depozito odulunu geri alabilir (Merkezi).",
									"Arena savasi kazanan olmadan biter",
									"Tum katilimcilar kendi kralliklarina isinlanacak.",
			};
