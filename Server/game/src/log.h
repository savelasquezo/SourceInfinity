...
//		void		DungeonRegistros(DWORD dwPlayerID, const char* szPlayerName, DWORD dwPlayerLevel, DWORD dwAtaque, DWORD index);
//		void		DungeonRanking(DWORD dwPlayerID, const char* szPlayerName, DWORD dwPlayerLevel, DWORD dwPunto, DWORD index);
//#endif
