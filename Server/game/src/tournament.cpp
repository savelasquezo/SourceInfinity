...
static const char* LC_TRANSLATE(const char* key) /* Configurable */
{
	...
	LC_TRANSLATE["TOURNAMENT_CATEGORY_LOW"]								= "Bajo";	
	LC_TRANSLATE["TOURNAMENT_CATEGORY_MEDIUM"]							= "Medio";	
	LC_TRANSLATE["TOURNAMENT_CATEGORY_HARD"]							= "Alto";

	LC_TRANSLATE["TOURNAMENT_TEAM_MEMBER_RED"]							= "Rojo";		
	LC_TRANSLATE["TOURNAMENT_TEAM_MEMBER_BLUE"]							= "Azul";	
	
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_BEFORE_START"]				= "<Torneo PvP>La Categoría %s Comenzará en %d Minutos.";

	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_START_LINE_1"]				= "<Torneo PvP> Categoría %s ha Comenzado, Buena Suerte a los dos Equipos.";
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_START_LINE_2"]				= "<Torneo PvP> la Duración de la Pelea es de %d minutos.";
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_START_LINE_3"]				= "<Torneo PvP> Para presenciar las peleas, haz clic en la misión de la izquierda.";

	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_NOT_STARTED_LINE_1"]			= "<Torneo PvP> El número de jugadores es insuficiente para la categoría [%s], por lo que la pelea no puede comenzar.";
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_NOT_STARTED_LINE_2"]			= "<Torneo PVP> En %s, la categoría [%s] comenzará.";
	
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_FINISHED_LINE_1"]				= "<Torneo PvP> Categoría %s ha finalizado.";
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_FINISHED_LINE_2"]				= "<Torneo PvP> En %s, comenzará la categoría [%s].";

	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_WINNER_SAME"]					= "<Torneo PvP> La pelea terminó en empate, ambos equipos tienen el mismo número de miembros en pie.";
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_WINNER_NOT_EXIST"]			= "<Torneo PvP> Ningún equipo ha ganado el torneo, porque no quedaban miembros en pie.";
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_WINNER_SUCCES"]				= "<Torneo PvP> Felicitaciones equipo %s, Ha ganado el torneo con %d miembros en pie.";

	LC_TRANSLATE["TOURNAMENT_MEMBER_REMAINING_LIFE"]					= "<Torneo PvP> Tienes %d vidas.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_FINISHED_LIFE_LINE_1"]				= "<Torneo PvP> No te quedan vidas.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_FINISHED_LIFE_LINE_2"]				= "<Torneo PvP> ¡Has sido eliminado del torneo, la próxima vez prepárate más!";
	LC_TRANSLATE["TOURNAMENT_MEMBER_DIVIDED"]							= "<Torneo PvP> Te han asignado al equipo %s.";

	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_DUEL"]						= "<Torneo PvP> No puedes desafiar a un duelo en este mapa.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_PARTY"]						= "<Torneo PvP> No puedes usar grupo en este mapa.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_RING_MARRIAGE"]				= "<Torneo PvP> No puedes usar el anillo de bodas en este mapa.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_POLY"]						= "<Torneo PvP> No puedes.transformarte en este mapa.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_CHANGE_PKMODE"]				= "<Torneo PvP> No puedes usar las opciones de PVP en este mapa.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_MOUNT"]						= "<Torneo PvP> No puedes montar una montura en este mapa.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_HORSE"]						= "<Torneo PvP> No puedes montar a caballo en este mapa.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_EXIT_OBSERVER_MODE_LINE_1"]	= "<Torneo PvP> No puedes cambiar el mod de observador en este mapa.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_EXIT_OBSERVER_MODE_LINE_2"]	= "<Torneo PvP> Si quieres salir del mapa usa la misión de la izquierda.";
	
	LC_TRANSLATE["TOURNAMENT_MEMBER_OPEN_REWARD_WRONG_SIZE"]			= "<Torneo PvP> No puedes usar esto porque necesitas tener un mínimo de %d espacios libres en el inventario.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_CANNOT_USE_ITEM"]					= "<Torneo PvP> No puedes usar el artículo %s porque está restringido.";
	LC_TRANSLATE["TOURNAMENT_INSERT_LOG_WINNERS"]						= "Nombre: %s | Nivel: %d | IP: %s | Vida restante: %d | Equipo: %s";
	
#ifdef ENABLE_EXTRA_LIVES_TOURNAMENT
	LC_TRANSLATE["TOURNAMENT_MEMBER_ADD_EXTRA_LIVES_ERROR_LINE_1"]		= "<Torneo PvP> No puedes usar este objeto aquí, debes hacerlo antes para estar aquí";
	LC_TRANSLATE["TOURNAMENT_MEMBER_ADD_EXTRA_LIVES_ERROR_LINE_2"]		= "<Torneo PvP> Ya hiciste eso recientemente, no puedes volver a hacerlo tan rápido, necesitas terminar todas las vidas extra.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_ADD_EXTRA_LIVES_ERROR_LINE_3"]		= "<Torneo PvP> Total de vida extra restante: %d de %d.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_ADD_EXTRA_LIVES_SUCCES"]			= "<Tournament PvP> Felicitaciones, se agregó +%d vida en el torneo, están disponibles por %d veces la participación.";
#endif
...
const int TOURNAMENT_INFO_TIMER[TOURNAMENT_MAX_CATEGORY][4] = /* Configurable */
{
	...
	*/
	{ 03, 00,	03, 30 }, // TOURNAMENT_CATEGORY_LOW
	{ 05, 00,	05, 30 }, // TOURNAMENT_CATEGORY_MEDIUM
	{ 07, 00,	07, 30 }  // TOURNAMENT_CATEGORY_HARD
};
