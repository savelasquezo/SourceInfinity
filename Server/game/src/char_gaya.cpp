...
const char* txt_gaya[] = {
	LC_TEXT("[Gaya] Gayas Insuficientes."),
	LC_TEXT("[Gaya] Error."),
	LC_TEXT("[Gaya] Nesecitas %d %s para hacer esto."),
	LC_TEXT("[Gaya] Insuficientes Monedas."),
	LC_TEXT("[Gaya] Modenas Gaya: %d."),
	LC_TEXT("[Gaya] La conversion fue un exito."),
	LC_TEXT("[Gaya] La conversion no tuvo exito.")
};
