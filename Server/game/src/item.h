...
class CItem : public CEntity
{
	...
	public:
		...
		void		SetForceAttributeTransfer(int i, BYTE bType, short sValue);
		void		SetForceAttributeHitSkill(int i, BYTE bType, short sValue);
		void		SetForceAttributeNewPets(int i, BYTE bType, short sValue);
		void		SetForceAttributeDragonSoul(int i, BYTE bType, short sValue);
		void		SetForceAttributeCubeRenewal(int i, BYTE bType, short sValue);
		void		SetForceAttributePets(int i, BYTE bType, short sValue);
		void		SetForceAttributeNewEnchant(int i, BYTE bType, short sValue);
		void		SetForceAttributeChars(int i, BYTE bType, short sValue);
		void		SetForceAttributeCharItem(int i, BYTE bType, short sValue);
