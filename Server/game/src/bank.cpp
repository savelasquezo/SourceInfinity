...
{
	"<Banco> Algunos caracteres no están permitidos.",
	"<Banco> La clave es incorrecta, debe contener 4 caracteres.",
	"<Banco> La cuenta %s ya existe!.",
	"<Banco> Cuenta %s creada correctamente! clave: %s.",
	
	"<Banco> La cuenta de %s que intentaste enviar Yang no existe.",
	"<Banco> Esta cantidad de Yang es demasiado baja.",
	"<Banco> No eres dueño de este Yang en el banco.",
	"<Banco> Yang enviado correctamente: [Nombre de cuenta: %s, Cantidad: %d].",

	"<Banco> La cantidad de Yang que ingresó es demasiado baja.",
	"<Banco> Tienes muy poco Yang.",
	"<Banco> El monto del retiro es mayor que el monto actual.",
	"<Banco> No tienes este Yang en el banco.",
	"<Banco> No tienes esta cantidad de Yang en el inventario.",

	"<Banco> La clave es incorrecta, debe contener 4 caracteres.",
	"<Banco> La repetición de la clave es incorrecta, debe tener 4 caracteres.",
	"<Banco> Las clave no coinciden.",
	"<Banco> La clave repetida no es la misma que la primera clave ..",
	"<Banco> Ya tiene esta clave, elija otra clave.",
	"<Banco> Tu clave se ha cambiado correctamente! Nueva clave: %s",

	"<Banco> ¡No puedes hacer esto tan rápido, tienes que esperar %d segundos!."
};
...
bool BankManager::Send_Money(LPCHARACTER ch, const char* mAccount, const char* mPassword, const char* mTargetAccount, const char* mAmount)
{
	...
	//{
	//	ch->ChatPacket(CHAT_TYPE_INFO, "<Banco> No puedes enviarte dinero a ti mismo.");
	//	return false;
	//}
