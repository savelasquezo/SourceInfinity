...
int pTableTime[10] =
{ 
	60*1, // Biologist level 30	//10minute
	60*1, // Biologist level 40	//10minute
	60*1, // Biologist level 50	//10minute
	60*1, // Biologist level 60	//10minute
	60*1, // Biologist level 70	//10minute
	60*1, // Biologist level 80	//10minute
	60*1, // Biologist level 85	//30minute
	60*30, // Biologist level 90	//30minute
	60*30, // Biologist level 92	//90minute
	60*30 // Biologist level 94 	//90minute
}; 
#endif
