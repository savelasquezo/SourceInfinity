...
void CInputLogin::Entergame(LPDESC d, const char * data)
{
	...
	if (ch->GetQuestFlag("costume_option.hide_sash") != 0)
		ch->SetSashCostumeHidden(true);
	else
		ch->SetSashCostumeHidden(false);
#endif
	...
	if (ch->GetQuestFlag("auto_afk_system.afk") == 1)
	{
		...
		ch->SetQuestFlag("auto_afk_system.afk", 0);
	}
...
#ifdef __ENABLE_MINIGAME_BOSSHUNTERS__
	if (ch->GetQuestFlag("boss_hunters.boss_hunters_start_timestamp") != 0)
	{
		char buf[64];
		snprintf(buf, sizeof(buf), "BossHuntersTimeStamp %d", ch->GetQuestFlag("boss_hunters.boss_hunters_start_timestamp")+86400);
		ch->ChatPacket(CHAT_TYPE_COMMAND, buf);
		char buf2[512];
		snprintf(buf2, sizeof(buf2), "BossHuntersClearMission %d %d %d %d %d %d %d %d", ch->GetQuestFlag("boss_hunters.boss_hunters_day0"), ch->GetQuestFlag("boss_hunters.boss_hunters_day1"), ch->GetQuestFlag("boss_hunters.boss_hunters_day2"), ch->GetQuestFlag("boss_hunters.boss_hunters_day3"), ch->GetQuestFlag("boss_hunters.boss_hunters_day4"), ch->GetQuestFlag("boss_hunters.boss_hunters_day5"), ch->GetQuestFlag("boss_hunters.boss_hunters_day6"), ch->GetQuestFlag("boss_hunters.boss_hunters_day7"));
