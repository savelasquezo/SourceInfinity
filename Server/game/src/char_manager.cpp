...
LPCHARACTER CHARACTER_MANAGER::SpawnMob(DWORD dwVnum, long lMapIndex, long x, long y, long z, bool bSpawnMotion, int iRot, bool bShow, bool isOfflineShopNPC, DWORD real_owner, bool bAggressive)
#else
...
const DWORD* CHARACTER_MANAGER::GetUsableSkillList(BYTE bJob, BYTE bSkillGroup) const
{
	...
	static const DWORD SkillList[JOB_MAX_NUM][SKILL_GROUP_MAX_NUM][7] =
	{
		...
		{ {	170,171,172,173,174,175,176	}, {	0,	0,	0,	0,	0,	0,	0	} },
	};
