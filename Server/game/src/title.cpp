...
*/
#define need_gold_1		5000000
#define need_gold_2		8000000
#define need_gold_3		15000000
#define need_gold_4		18000000
#define need_gold_5		25000000
#define need_gold_6		30000000
#define need_gold_7		40000000
#define need_gold_8		50000000
#define need_gold_9		100000000
#define need_gold_10	150000000
#define need_gold_11	250000000
#define need_gold_12	500000000
#define need_gold_13	750000000
#define need_gold_14	1000000000
#define need_gold_15	1500000000
#define need_gold_16	1750000000

/*****************************
* Set requirements level for title
*/
#define need_level_1	10
#define need_level_2	15
#define need_level_3	20
#define need_level_4	30
#define need_level_5	35
#define need_level_6	40
#define need_level_7	50
#define need_level_8	65
#define need_level_9	75
#define need_level_10	80
#define need_level_11	90
#define need_level_12	110
#define need_level_13	120
#define need_level_14	130
#define need_level_15	140
#define need_level_16	150

/*****************************
* Set requirements level for playTime on character
*/
#define need_minutes_1	30
#define need_minutes_2	90
#define need_minutes_3	180
#define need_minutes_4	360													
#define need_minutes_5	720
#define need_minutes_6	1440
#define need_minutes_7	2880
#define need_minutes_8	5760
#define need_minutes_9	11220
#define need_minutes_10	22440
#define need_minutes_11	30000
#define need_minutes_12	35000
#define need_minutes_13	40000
#define need_minutes_14	50000
#define need_minutes_15	60000
#define need_minutes_16	70000	
...
int pTitleBonus_2[] = {POINT_ATTBONUS_MONSTER, 25};
int pTitleBonus_3[] = {POINT_CRITICAL_PCT, 20};
...
const char* requirements[] = {
									"[Sistema de Titulos] Debes tener al menos %u yang para este titulo!", 
									"[Sistema de Titulos] Debes tener un nivel minimo de %u para este titulo!",
									"[Sistema de Titulos] Debes tener minutos jugados en el personaje: %u"};							
const char* title_translate[] = {
									"[Sistema de Titulos] Tienes que esperar %u hora para poder comprar una pocion de nuevo! ",
									"[Sistema de Titulos] No tienes suficientes monedas en tu cuenta dragon! Carga para comprar! ",
									"[Sistema de Titulos] El bono premium recibido el titulo desaparecio! ",
									"[Sistema de Titulos] Tu titulo ha sido eliminado! Recibiste x1 Pocion amarilla encantada! ",
									"[Sistema de Titulos] Tu titulo ha sido eliminado! Recibido x1 Pocion rosada encantada! ",					
									"[Sistema de Titulos] Tu titulo ha sido eliminado! Recibiste x1 Pocion blanca encantada! ",
									"[Sistema de Titulos] No tienes un titulo premium para transformaciones! ",
									"[Sistema de Titulos] Tienes una prima de titulo adjunta, ¡no puedes hacer eso! ",
									"[Sistema de Titulos] Ya tienes este titulo! ",
									"[Sistema de Titulos] Debes tener una Pocion Amarilla Encantada x1! ",
									"[Sistema de Titulos] Debes tener una pocion rosa encantada x1! ",
									"[Sistema de Titulos] Debes tener una Pocion Blanca Encantada x1! ",
									"[Sistema de Titulos] Tu titulo ha sido eliminado! "};							
