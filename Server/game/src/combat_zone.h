...
enum ECombatZoneSettings
{
	...
	COMBAT_ZONE_SHOP_MAX_LIMIT_POINTS = 300, // The maximum limit of points that is admitted per day, every evening at 00:00, resets to 0;
	COMBAT_ZONE_MONSTER_KILL_MAX_LIMIT = 100, // The maximum limit you need to kill monsters to get the potion once every 6 hours;

	COMBAT_ZONE_MAX_DEATHS_TO_INCREASE_TIMER_RESTART = 3, // When you have 4 deaths that means 20 seconds + 10 default = 30, will be reseted the deaths to 0, so next time for can restart will be default 10 secs, when you dead again + 5 = 15 etc;
	...
	COMBAT_ZONE_ADD_POINTS_NORMAL_KILLING = 3, // When you kill a player regular;
	...
	COMBAT_ZONE_REQUIRED_POINTS_TO_LEAVING = 3, // How many points you need for can announced your withdrawal - 5 points;
